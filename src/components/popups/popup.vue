<template>
  <div class="popupWrap" :style='stylePopup'>
    <case-detail v-if="componentName === 'case'" :caseId="mapData.caseId_" :info="mapData.caseDefaultInfo_" @open="openDragContainer_" @close="handleCaseDetailClose_"></case-detail>
