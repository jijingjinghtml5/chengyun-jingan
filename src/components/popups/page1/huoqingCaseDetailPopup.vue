<template>
    <div  class="panel">
      ...
      <div class="basic-info">
        ...
        <div class="item">
          <span>报警人联系电话: </span>
          <span>{{ detail.bjrlxdh }}</span>
        </div>
        <div class="item">
          <span>报警人姓名: </span>
          <span>{{ detail.bjrxm }}</span>
        </div>
        <div class="item">
          <span>处置对象: </span>
        ...
        <div class="item">
          ...
          <template v-if="detail.zbzsList && detail.zbzsList.length">
            <div v-for="(item, index) in detail.zbzsList" :key="index" style="margin-top: 10px" class="zhihuren-info">
                <div>
                    <span>联系人信息：</span>
                    <span style="color: #FFFFFF;">{{ item.contactInfo }}</span>
                </div>
                <div>
                    <span>支队简称：</span>
                ...
                <div>
                    <span>岗位序号：</span>
                    <span style="color: #FFFFFF;">{{ item.gwxh }}</span>
                </div>
                <div>
                    <span>身份证号：</span>
                <span style="color: #FFFFFF;">{{ item.idNumber }}</span>
                </div>
                <div>
                    <span>人员姓名：</span>
                <span style="color: #FFFFFF;">{{ item.personName }}</span>
                </div>
                <div>
                    <span>岗位名称：</span>
                ...
                <div>
                    <span>人员序号：</span>
                <span style="color: #FFFFFF;">{{ item.ryxh }}</span>
                </div>
                <div>
                    <span>人员联系电话：</span>
                <span style="color: #FFFFFF;">{{ item.tel }}</span>
                </div>
                <div>
                    <span>值班日期：</span>
